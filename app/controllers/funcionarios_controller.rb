class FuncionariosController < ApplicationController
  ...
  private
    ...
    def funcionario_params
      params.require(:funcionario).permit(:nome, :cpf, :data_nascimento, :endereco, :telefone, :email, :cargo, :salario, :data_admissao, :ativo, :departamento, :genero, :estado_civil, :identificacao)
    end
end
